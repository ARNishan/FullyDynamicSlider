        ...
        <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    // Session::set('update','Post Updated Successfully !!');
                    // echo "<script>window.location.replace('viewPost.php');</script>";
                    echo "<span class='success'>Post Updated Successfully !!</span>";
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $data['title'];?>" id="Title" placeholder="Enter Title" name= "title">
                        </div>
                        <div class="form-group">
                            <label for="Upload_Image">Uploaded Image</label>
                            <img src="<?php echo $data['image'];?>" height = "80px" width = "50px" /><br/>
                            <input type="file" class="form-control" name="image">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Content</label>
                            <textarea class="tinymce" id="exampleFormControlTextarea1" rows="5" name="body"><?php echo $data['body'];?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="tags">Tags</label>
                            <input type="text" class="form-control" value="<?php echo $data['tags'];?>"  name= "tags" id="tags" placeholder="Enter Tags">
                        </div>
